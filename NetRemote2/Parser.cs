/*
 ...
 https://github.com/mpeirone/SDRSharp-Net-Remote2

 Copyright 2022 mpeirone
    ...
    class Parser
    {
        ...
        public string Parse(string data)
        {
            ...
            catch (Exception ex)
            {
                if (ex is ArgumentOutOfRangeException)
                    ...
                    ex is InvalidOperationException || ex is System.Text.Json.JsonException)
        ...
        private object CheckValue<T>(object value)
        {
            ...
            try
            {
                if (typeExpected == typeof(bool))
                    return (object)Boolean.Parse(value.ToString());
                if (typeExpected == typeof(int) || typeExpected == typeof(long))
                    return (object)int.Parse(value.ToString());
            ...
            {
                throw new ValueException("Expected a " + typeExpected.ToString());
            }
        ...
        private string CmdCentreFrequency(bool set, object value)
        {
            ...
            if (set)
            {
                ...
                long freq = (long)CheckValue<long>(value);
